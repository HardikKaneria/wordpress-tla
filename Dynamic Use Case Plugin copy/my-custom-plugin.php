...
{
    wp_enqueue_script('use-case-search', plugin_dir_url(__FILE__) . 'assets/js/use-case-search.js', array('jquery'), null, true);
...
function export_use_cases_table() {
    if (!current_user_can('manage_options')) {
        return;
    }

    MyCustomPlugin\Table_Handler::export_table_to_csv_and_delete('use_cases');
}
add_action('admin_post_export_use_cases', 'export_use_cases_table');
