...
class Table_Handler
{
    ...
    /**
     * Export data from the specified table to a CSV file and then delete the table.
     * 
     * @param string $table_name Name of the table to export data from.
     */
    public static function export_table_to_csv_and_delete($table_name)
    {
        global $wpdb;
        $table_name = $wpdb->prefix . $table_name;
        ...
        // Exit to ensure CSV download works
        exit;
    }
}
